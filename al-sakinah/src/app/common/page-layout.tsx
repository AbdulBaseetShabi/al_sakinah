...
const NavigationLargeScreen: React.FC<{}> = ({}) => {
  return (
    // <div className="navbar hidden lg:flex" style={{ color: 'white', backgroundColor: '#3A3042'}}>
    <div className="navbar hidden lg:flex">
      ...
      <div className="navbar-end flex">
        <div className="w-48">
          <Button text="Quick Donate" link="https://www.paypal.com/donate/?hosted_button_id=26A2M76SX392C"/>
        </div>
      </div>
    </div>
  );
      ...
      <div className="navbar-end">
        <div className="dropdown dropdown-end">
          ...
          >
            ...
            <Button text="Donate" link="https://www.paypal.com/donate/?hosted_button_id=26A2M76SX392C"/>
          </ul>
        </div>
      </div>
    </div>
